...
ssize_t circular_proc_write(struct file *filep, char *buff, size_t count, loff_t *offp);
ssize_t circular_read(struct file *filep, char *buff, size_t count, loff_t *offp);
ssize_t circular_write(struct file *filep, char *buff, size_t count, loff_t *offp);
static int __init circular_init(void);
static int __exit circular_exit(void);
