...
ssize_t jiffies_write(struct file *filep, char *buff, size_t count, loff_t *offp);
...
static int __init reverse_init(void)
{
  ...
  if (res)
  {
    printk("[CIRCULAR] Could not allocate memory");
    return res;
  }
  ...
  if (res)
  {
    ...
    printk("[CIRCULAR] Could not create jiffies character device!");
    return res;
  }
  ...
  if (res)
  {
    ...
    printk("[CIRCULAR] Could not create prname character device!");
    return res;
  }
